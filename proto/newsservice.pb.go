...
type LastNews struct {
	...
	News *_struct.Struct `protobuf:"bytes,1,opt,name=news,proto3" json:"news,omitempty"`
}
...
var file_newsservice_proto_rawDesc = []byte{
	...
	0x73, 0x12, 0x2b, 0x0a, 0x04, 0x6e, 0x65, 0x77, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
