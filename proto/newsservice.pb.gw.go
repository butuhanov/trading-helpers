...
/*
Package news is a reverse proxy.
...
func RegisterNewsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NewsServiceServer) error {
	...
	mux.Handle("POST", pattern_NewsService_GetNews_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
var (
	pattern_NewsService_GetNews_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "news", "last"}, "", runtime.AssumeColonVerbOpt(true)))
)
